...
public abstract class JedisClusterConnectionHandler implements Closeable {
  ...
  private void initializeSlotsCache(Set<HostAndPort> startNodes, GenericObjectPoolConfig poolConfig, String password, String clientName) {
    for (HostAndPort hostAndPort : startNodes) {
      ...
      Jedis jedis = new Jedis(hostAndPort.getHost(), hostAndPort.getPort(), hostAndPort.isSsl(), hostAndPort.getSslSocketFactory(), hostAndPort.getSslParameters(), hostAndPort.getHostnameVerifier());
